...
function Spawn( entityKeyValues )
    ...
    behaviorSystem = AICore:CreateBehaviorSystem( { BehaviorNone, BehaviorDismember, BehaviorThrowHook} ) 
end
...
AICore.possibleBehaviors = { BehaviorNone, BehaviorDismember, BehaviorThrowHook }
