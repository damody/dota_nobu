...
[VScript]: 
[VScript]: ---[[ IsInToolsMode  Returns true if this is lua running within tools mode. ]]
[VScript]: -- @return bool
[VScript]: function IsInToolsMode(  ) end
[VScript]: 
...
[VScript]: 
[VScript]: ---[[ PrecacheUnitFromTableAsync  Precaches a DOTA unit from a table of entity key values. ]]
[VScript]: -- @return void
[VScript]: -- @param handle_1 handle
[VScript]: -- @param handle_2 handle
[VScript]: function PrecacheUnitFromTableAsync( handle_1, handle_2 ) end
[VScript]: 
[VScript]: ---[[ PrecacheUnitFromTableSync  Precaches a DOTA unit from a table of entity key values. ]]
[VScript]: -- @return void
[VScript]: -- @param handle_1 handle
[VScript]: -- @param handle_2 handle
[VScript]: function PrecacheUnitFromTableSync( handle_1, handle_2 ) end
[VScript]: 
...
[VScript]: DOTA_ABILITY_BEHAVIOR_VECTOR_TARGETING = 1073741824
[VScript]: DOTA_ABILITY_LAST_BEHAVIOR = 1073741824
[VScript]: 
...
[VScript]: MODIFIER_EVENT_ON_ATTACK_FINISHED = 158 -- OnAttackFinished
...
[VScript]: MODIFIER_FUNCTION_LAST = 160
...
[VScript]: MODIFIER_PROPERTY_IGNORE_COOLDOWN = 159 -- GetModifierIgnoreCooldown
...
[VScript]: 
[VScript]: ---[[ CBaseModelEntity:GetRenderAlpha  GetRenderAlpha(): Get the alpha modulation of this entity. ]]
[VScript]: -- @return int
[VScript]: function CBaseModelEntity:GetRenderAlpha(  ) end
[VScript]: 
...
[VScript]: 
[VScript]: ---[[ CBaseModelEntity:SetRenderAlpha  SetRenderAlpha( int ): Set the alpha modulation of this entity. ]]
[VScript]: -- @return void
[VScript]: -- @param nAlpha int
[VScript]: function CBaseModelEntity:SetRenderAlpha( nAlpha ) end
[VScript]: 
...
[VScript]: 
[VScript]: ---[[ CDOTABaseGameMode:ClearItemAddedToInventoryFilter  Clear the script filter that controls the item added to inventory filter. ]]
[VScript]: -- @return void
[VScript]: function CDOTABaseGameMode:ClearItemAddedToInventoryFilter(  ) end
[VScript]: 
...
[VScript]: 
[VScript]: ---[[ CDOTABaseGameMode:GetAlwaysShowPlayerNames  Get whether player names are always shown, regardless of client setting. ]]
[VScript]: -- @return bool
[VScript]: function CDOTABaseGameMode:GetAlwaysShowPlayerNames(  ) end
[VScript]: 
...
[VScript]: 
[VScript]: ---[[ CDOTABaseGameMode:SetAlwaysShowPlayerNames  Set whether player names are always shown, regardless of client setting. ]]
[VScript]: -- @return void
[VScript]: -- @param bEnabled bool
[VScript]: function CDOTABaseGameMode:SetAlwaysShowPlayerNames( bEnabled ) end
[VScript]: 
...
[VScript]: -- @return void
[VScript]: -- @param int_1 int
[VScript]: function CDOTABaseGameMode:SetCustomHeroMaxLevel( int_1 ) end
[VScript]: 
...
[VScript]: 
[VScript]: ---[[ CDOTABaseGameMode:SetItemAddedToInventoryFilter  Set a filter function to control what happens to items that are added to an inventory, return false to cancel the event ]]
[VScript]: -- @return void
[VScript]: -- @param hFunction handle
[VScript]: -- @param hContext handle
[VScript]: function CDOTABaseGameMode:SetItemAddedToInventoryFilter( hFunction, hContext ) end
[VScript]: 
...
[VScript]: 
[VScript]: ---[[ CDOTAGamerules:AddMinimapDebugPoint  Add a point on the minimap. ]]
[VScript]: -- @return void
[VScript]: -- @param int_1 int
[VScript]: -- @param Vector_2 Vector
[VScript]: -- @param int_3 int
...
[VScript]: -- @param int_6 int
[VScript]: -- @param float_7 float
[VScript]: function CDOTAGamerules:AddMinimapDebugPoint( int_1, Vector_2, int_3, int_4, int_5, int_6, float_7 ) end
[VScript]: 
[VScript]: ---[[ CDOTAGamerules:AddMinimapDebugPointForTeam  Add a point on the minimap for a specific team. ]]
[VScript]: -- @return void
[VScript]: -- @param int_1 int
[VScript]: -- @param Vector_2 Vector
[VScript]: -- @param int_3 int
...
[VScript]: -- @param float_7 float
[VScript]: -- @param int_8 int
[VScript]: function CDOTAGamerules:AddMinimapDebugPointForTeam( int_1, Vector_2, int_3, int_4, int_5, int_6, float_7, int_8 ) end
[VScript]: 
[VScript]: ---[[ CDOTAGamerules:Defeated  Kills the ancient, etc. ]]
[VScript]: -- @return void
[VScript]: function CDOTAGamerules:Defeated(  ) end
[VScript]: 
[VScript]: ---[[ CDOTAGamerules:DidMatchSignoutTimeOut  true when we have waited some time after end of the game and not received signout ]]
[VScript]: -- @return bool
[VScript]: function CDOTAGamerules:DidMatchSignoutTimeOut(  ) end
[VScript]: 
[VScript]: ---[[ CDOTAGamerules:EnableCustomGameSetupAutoLaunch  Enabled (true) or disable (false) auto launch for custom game setup. ]]
[VScript]: -- @return void
[VScript]: -- @param bool_1 bool
[VScript]: function CDOTAGamerules:EnableCustomGameSetupAutoLaunch( bool_1 ) end
[VScript]: 
[VScript]: ---[[ CDOTAGamerules:FinishCustomGameSetup  Indicate that the custom game setup phase is complete, and advance to the game. ]]
[VScript]: -- @return void
[VScript]: function CDOTAGamerules:FinishCustomGameSetup(  ) end
[VScript]: 
[VScript]: ---[[ CDOTAGamerules:GetCustomGameDifficulty  Returns the difficulty level of the custom game mode ]]
[VScript]: -- @return int
[VScript]: function CDOTAGamerules:GetCustomGameDifficulty(  ) end
[VScript]: 
[VScript]: ---[[ CDOTAGamerules:GetCustomGameTeamMaxPlayers  Get whether a team is selectable during game setup ]]
[VScript]: -- @return int
[VScript]: -- @param int_1 int
[VScript]: function CDOTAGamerules:GetCustomGameTeamMaxPlayers( int_1 ) end
[VScript]: 
[VScript]: ---[[ CDOTAGamerules:GetDOTATime  (b IncludePregameTime b IncludeNegativeTime) Returns the actual DOTA in-game clock time. ]]
[VScript]: -- @return float
[VScript]: -- @param bool_1 bool
[VScript]: -- @param bool_2 bool
[VScript]: function CDOTAGamerules:GetDOTATime( bool_1, bool_2 ) end
[VScript]: 
[VScript]: ---[[ CDOTAGamerules:GetDifficulty  Returns difficulty level of the custom game mode ]]
[VScript]: -- @return int
[VScript]: function CDOTAGamerules:GetDifficulty(  ) end
[VScript]: 
[VScript]: ---[[ CDOTAGamerules:GetDroppedItem  Gets the Xth dropped item ]]
[VScript]: -- @return handle
[VScript]: -- @param int_1 int
[VScript]: function CDOTAGamerules:GetDroppedItem( int_1 ) end
[VScript]: 
[VScript]: ---[[ CDOTAGamerules:GetGameModeEntity  Get the game mode entity ]]
[VScript]: -- @return handle
[VScript]: function CDOTAGamerules:GetGameModeEntity(  ) end
[VScript]: 
[VScript]: ---[[ CDOTAGamerules:GetGameSessionConfigValue  Get a string value from the game session config (map options) ]]
[VScript]: -- @return string
[VScript]: -- @param string_1 string
[VScript]: -- @param string_2 string
[VScript]: function CDOTAGamerules:GetGameSessionConfigValue( string_1, string_2 ) end
[VScript]: 
[VScript]: ---[[ CDOTAGamerules:GetGameTime  Returns the number of seconds elapsed since map start. This time doesn't count up when the game is paused ]]
[VScript]: -- @return float
[VScript]: function CDOTAGamerules:GetGameTime(  ) end
[VScript]: 
[VScript]: ---[[ CDOTAGamerules:GetMatchID  Get the MatchID for this game. ]]
[VScript]: -- @return <unknown>
[VScript]: function CDOTAGamerules:GetMatchID(  ) end
[VScript]: 
[VScript]: ---[[ CDOTAGamerules:GetMatchSignoutComplete  Have we received the post match signout message that includes reward information ]]
[VScript]: -- @return bool
[VScript]: function CDOTAGamerules:GetMatchSignoutComplete(  ) end
[VScript]: 
[VScript]: ---[[ CDOTAGamerules:GetNianTotalDamageTaken  For New Bloom, get total damage taken by the Nian / Year Beast ]]
[VScript]: -- @return int
[VScript]: function CDOTAGamerules:GetNianTotalDamageTaken(  ) end
[VScript]: 
[VScript]: ---[[ CDOTAGamerules:GetPlayerCustomGameAccountRecord  (Preview/Unreleased) Gets the player's custom game account record, as it looked at the start of this session ]]
[VScript]: -- @return table
[VScript]: -- @param int_1 int
[VScript]: function CDOTAGamerules:GetPlayerCustomGameAccountRecord( int_1 ) end
[VScript]: 
[VScript]: ---[[ CDOTAGamerules:GetTimeOfDay  Get the time of day ]]
[VScript]: -- @return float
[VScript]: function CDOTAGamerules:GetTimeOfDay(  ) end
[VScript]: 
[VScript]: ---[[ CDOTAGamerules:IsCheatMode  Are cheats enabled on the server ]]
[VScript]: -- @return bool
[VScript]: function CDOTAGamerules:IsCheatMode(  ) end
[VScript]: 
[VScript]: ---[[ CDOTAGamerules:IsDaytime  Is it day time. ]]
[VScript]: -- @return bool
[VScript]: function CDOTAGamerules:IsDaytime(  ) end
[VScript]: 
[VScript]: ---[[ CDOTAGamerules:IsGamePaused  Returns whether the game is paused. ]]
[VScript]: -- @return bool
[VScript]: function CDOTAGamerules:IsGamePaused(  ) end
[VScript]: 
[VScript]: ---[[ CDOTAGamerules:LockCustomGameSetupTeamAssignment  Lock (true) or unlock (false) team assignemnt. If team assignment is locked players cannot change teams. ]]
[VScript]: -- @return void
[VScript]: -- @param bool_1 bool
[VScript]: function CDOTAGamerules:LockCustomGameSetupTeamAssignment( bool_1 ) end
[VScript]: 
[VScript]: ---[[ CDOTAGamerules:MakeTeamLose  Makes ths specified team lose ]]
[VScript]: -- @return void
[VScript]: -- @param int_1 int
[VScript]: function CDOTAGamerules:MakeTeamLose( int_1 ) end
[VScript]: 
[VScript]: ---[[ CDOTAGamerules:NumDroppedItems  Returns the number of items currently dropped on the ground ]]
[VScript]: -- @return int
[VScript]: function CDOTAGamerules:NumDroppedItems(  ) end
[VScript]: 
[VScript]: ---[[ CDOTAGamerules:PlayerHasCustomGameHostPrivileges  Whether a player has custom game host privileges (shuffle teams, etc.) ]]
[VScript]: -- @return bool
[VScript]: -- @param handle_1 handle
[VScript]: function CDOTAGamerules:PlayerHasCustomGameHostPrivileges( handle_1 ) end
[VScript]: 
[VScript]: ---[[ CDOTAGamerules:Playtesting_UpdateAddOnKeyValues  Updates custom hero, unit and ability KeyValues in memory with the latest values from disk ]]
[VScript]: -- @return void
[VScript]: function CDOTAGamerules:Playtesting_UpdateAddOnKeyValues(  ) end
[VScript]: 
[VScript]: ---[[ CDOTAGamerules:ResetDefeated  Restart after killing the ancient, etc. ]]
[VScript]: -- @return void
[VScript]: function CDOTAGamerules:ResetDefeated(  ) end
[VScript]: 
[VScript]: ---[[ CDOTAGamerules:ResetToHeroSelection  Restart the game at hero selection ]]
[VScript]: -- @return void
[VScript]: function CDOTAGamerules:ResetToHeroSelection(  ) end
[VScript]: 
[VScript]: ---[[ CDOTAGamerules:SendCustomMessage  Sends a message on behalf of a player. ]]
[VScript]: -- @return void
[VScript]: -- @param string_1 string
[VScript]: -- @param int_2 int
[VScript]: -- @param int_3 int
[VScript]: function CDOTAGamerules:SendCustomMessage( string_1, int_2, int_3 ) end
[VScript]: 
[VScript]: ---[[ CDOTAGamerules:SendCustomMessageToTeam  Sends a message on behalf of a player to the specified team. ]]
[VScript]: -- @return void
[VScript]: -- @param string_1 string
[VScript]: -- @param int_2 int
[VScript]: -- @param int_3 int
[VScript]: -- @param int_4 int
[VScript]: function CDOTAGamerules:SendCustomMessageToTeam( string_1, int_2, int_3, int_4 ) end
[VScript]: 
[VScript]: ---[[ CDOTAGamerules:SetCreepMinimapIconScale  (flMinimapCreepIconScale) - Scale the creep icons on the minimap. ]]
[VScript]: -- @return void
[VScript]: -- @param float_1 float
[VScript]: function CDOTAGamerules:SetCreepMinimapIconScale( float_1 ) end
[VScript]: 
[VScript]: ---[[ CDOTAGamerules:SetCustomGameAccountRecordSaveFunction  (Preview/Unreleased) Sets a callback to handle saving custom game account records (callback is passed a Player ID and should return a flat simple table) ]]
[VScript]: -- @return void
[VScript]: -- @param handle_1 handle
[VScript]: -- @param handle_2 handle
[VScript]: function CDOTAGamerules:SetCustomGameAccountRecordSaveFunction( handle_1, handle_2 ) end
[VScript]: 
[VScript]: ---[[ CDOTAGamerules:SetCustomGameDifficulty  Set the difficulty level of the custom game mode ]]
[VScript]: -- @return void
[VScript]: -- @param int_1 int
[VScript]: function CDOTAGamerules:SetCustomGameDifficulty( int_1 ) end
[VScript]: 
[VScript]: ---[[ CDOTAGamerules:SetCustomGameEndDelay  Sets the game end delay. ]]
[VScript]: -- @return void
[VScript]: -- @param float_1 float
[VScript]: function CDOTAGamerules:SetCustomGameEndDelay( float_1 ) end
[VScript]: 
[VScript]: ---[[ CDOTAGamerules:SetCustomGameSetupAutoLaunchDelay  Set the amount of time to wait for auto launch. ]]
[VScript]: -- @return void
[VScript]: -- @param float_1 float
[VScript]: function CDOTAGamerules:SetCustomGameSetupAutoLaunchDelay( float_1 ) end
[VScript]: 
[VScript]: ---[[ CDOTAGamerules:SetCustomGameSetupRemainingTime  Set the amount of remaining time, in seconds, for custom game setup. 0 = finish immediately, -1 = wait forever ]]
[VScript]: -- @return void
[VScript]: -- @param float_1 float
[VScript]: function CDOTAGamerules:SetCustomGameSetupRemainingTime( float_1 ) end
[VScript]: 
[VScript]: ---[[ CDOTAGamerules:SetCustomGameSetupTimeout  Setup (pre-gameplay) phase timeout. 0 = instant, -1 = forever (until FinishCustomGameSetup is called) ]]
[VScript]: -- @return void
[VScript]: -- @param float_1 float
[VScript]: function CDOTAGamerules:SetCustomGameSetupTimeout( float_1 ) end
[VScript]: 
[VScript]: ---[[ CDOTAGamerules:SetCustomGameTeamMaxPlayers  Set whether a team is selectable during game setup ]]
[VScript]: -- @return void
[VScript]: -- @param int_1 int
[VScript]: -- @param int_2 int
[VScript]: function CDOTAGamerules:SetCustomGameTeamMaxPlayers( int_1, int_2 ) end
[VScript]: 
[VScript]: ---[[ CDOTAGamerules:SetCustomVictoryMessage  Sets the victory message. ]]
[VScript]: -- @return void
[VScript]: -- @param string_1 string
[VScript]: function CDOTAGamerules:SetCustomVictoryMessage( string_1 ) end
[VScript]: 
[VScript]: ---[[ CDOTAGamerules:SetCustomVictoryMessageDuration  Sets the victory message duration. ]]
[VScript]: -- @return void
[VScript]: -- @param float_1 float
[VScript]: function CDOTAGamerules:SetCustomVictoryMessageDuration( float_1 ) end
[VScript]: 
[VScript]: ---[[ CDOTAGamerules:SetFirstBloodActive  Sets whether First Blood has been triggered. ]]
[VScript]: -- @return void
[VScript]: -- @param bool_1 bool
[VScript]: function CDOTAGamerules:SetFirstBloodActive( bool_1 ) end
[VScript]: 
[VScript]: ---[[ CDOTAGamerules:SetGameWinner  Makes ths specified team win ]]
[VScript]: -- @return void
[VScript]: -- @param int_1 int
[VScript]: function CDOTAGamerules:SetGameWinner( int_1 ) end
[VScript]: 
[VScript]: ---[[ CDOTAGamerules:SetGoldPerTick  Set the auto gold increase per timed interval. ]]
[VScript]: -- @return void
[VScript]: -- @param int_1 int
[VScript]: function CDOTAGamerules:SetGoldPerTick( int_1 ) end
[VScript]: 
[VScript]: ---[[ CDOTAGamerules:SetGoldTickTime  Set the time interval between auto gold increases. ]]
[VScript]: -- @return void
[VScript]: -- @param float_1 float
[VScript]: function CDOTAGamerules:SetGoldTickTime( float_1 ) end
[VScript]: 
[VScript]: ---[[ CDOTAGamerules:SetHeroMinimapIconScale  (flMinimapHeroIconScale) - Scale the hero minimap icons on the minimap. ]]
[VScript]: -- @return void
[VScript]: -- @param float_1 float
[VScript]: function CDOTAGamerules:SetHeroMinimapIconScale( float_1 ) end
[VScript]: 
[VScript]: ---[[ CDOTAGamerules:SetHeroRespawnEnabled  Control if the normal DOTA hero respawn rules apply. ]]
[VScript]: -- @return void
[VScript]: -- @param bool_1 bool
[VScript]: function CDOTAGamerules:SetHeroRespawnEnabled( bool_1 ) end
[VScript]: 
[VScript]: ---[[ CDOTAGamerules:SetHeroSelectionTime  Sets the amount of time players have to pick their hero. ]]
[VScript]: -- @return void
[VScript]: -- @param float_1 float
[VScript]: function CDOTAGamerules:SetHeroSelectionTime( float_1 ) end
[VScript]: 
[VScript]: ---[[ CDOTAGamerules:SetHideKillMessageHeaders  Sets whether the multikill, streak, and first-blood banners appear at the top of the screen. ]]
[VScript]: -- @return void
[VScript]: -- @param bool_1 bool
[VScript]: function CDOTAGamerules:SetHideKillMessageHeaders( bool_1 ) end
[VScript]: 
[VScript]: ---[[ CDOTAGamerules:SetOverlayHealthBarUnit  Show this unit's health on the overlay health bar ]]
[VScript]: -- @return void
[VScript]: -- @param handle_1 handle
[VScript]: -- @param int_2 int
[VScript]: function CDOTAGamerules:SetOverlayHealthBarUnit( handle_1, int_2 ) end
[VScript]: 
[VScript]: ---[[ CDOTAGamerules:SetPostGameTime  Sets the amount of time players have between the game ending and the server disconnecting them. ]]
[VScript]: -- @return void
[VScript]: -- @param float_1 float
[VScript]: function CDOTAGamerules:SetPostGameTime( float_1 ) end
[VScript]: 
[VScript]: ---[[ CDOTAGamerules:SetPreGameTime  Sets the amount of time players have between picking their hero and game start. ]]
[VScript]: -- @return void
[VScript]: -- @param float_1 float
[VScript]: function CDOTAGamerules:SetPreGameTime( float_1 ) end
[VScript]: 
[VScript]: ---[[ CDOTAGamerules:SetRuneMinimapIconScale  (flMinimapRuneIconScale) - Scale the rune icons on the minimap. ]]
[VScript]: -- @return void
[VScript]: -- @param float_1 float
[VScript]: function CDOTAGamerules:SetRuneMinimapIconScale( float_1 ) end
[VScript]: 
[VScript]: ---[[ CDOTAGamerules:SetRuneSpawnTime  Sets the amount of time between rune spawns. ]]
[VScript]: -- @return void
[VScript]: -- @param float_1 float
[VScript]: function CDOTAGamerules:SetRuneSpawnTime( float_1 ) end
[VScript]: 
[VScript]: ---[[ CDOTAGamerules:SetSafeToLeave  (bSafeToLeave) - Mark this game as safe to leave. ]]
[VScript]: -- @return void
[VScript]: -- @param bool_1 bool
[VScript]: function CDOTAGamerules:SetSafeToLeave( bool_1 ) end
[VScript]: 
[VScript]: ---[[ CDOTAGamerules:SetSameHeroSelectionEnabled  When true, players can repeatedly pick the same hero. ]]
[VScript]: -- @return void
[VScript]: -- @param bool_1 bool
[VScript]: function CDOTAGamerules:SetSameHeroSelectionEnabled( bool_1 ) end
[VScript]: 
[VScript]: ---[[ CDOTAGamerules:SetStartingGold  Set the starting gold amount. ]]
[VScript]: -- @return void
[VScript]: -- @param int_1 int
[VScript]: function CDOTAGamerules:SetStartingGold( int_1 ) end
[VScript]: 
[VScript]: ---[[ CDOTAGamerules:SetTimeOfDay  Set the time of day. ]]
[VScript]: -- @return void
[VScript]: -- @param float_1 float
[VScript]: function CDOTAGamerules:SetTimeOfDay( float_1 ) end
[VScript]: 
[VScript]: ---[[ CDOTAGamerules:SetTreeRegrowTime  Sets the tree regrow time in seconds. ]]
[VScript]: -- @return void
[VScript]: -- @param float_1 float
[VScript]: function CDOTAGamerules:SetTreeRegrowTime( float_1 ) end
[VScript]: 
[VScript]: ---[[ CDOTAGamerules:SetUseBaseGoldBountyOnHeroes  Heroes will use the basic NPC functionality for determining their bounty, rather than DOTA specific formulas. ]]
[VScript]: -- @return void
[VScript]: -- @param bool_1 bool
[VScript]: function CDOTAGamerules:SetUseBaseGoldBountyOnHeroes( bool_1 ) end
[VScript]: 
[VScript]: ---[[ CDOTAGamerules:SetUseCustomHeroXPValues  Allows heroes in the map to give a specific amount of XP (this value must be set). ]]
[VScript]: -- @return void
[VScript]: -- @param bool_1 bool
[VScript]: function CDOTAGamerules:SetUseCustomHeroXPValues( bool_1 ) end
[VScript]: 
[VScript]: ---[[ CDOTAGamerules:SetUseUniversalShopMode  When true, all items are available at as long as any shop is in range. ]]
[VScript]: -- @return void
[VScript]: -- @param bool_1 bool
[VScript]: function CDOTAGamerules:SetUseUniversalShopMode( bool_1 ) end
[VScript]: 
[VScript]: ---[[ CDOTAGamerules:State_Get  Get the current Gamerules state ]]
[VScript]: -- @return int
[VScript]: function CDOTAGamerules:State_Get(  ) end
[VScript]: 
...
[VScript]: 
[VScript]: ---[[ CDOTATutorial:AddBot  Add a computer controlled bot. ]]
[VScript]: -- @return bool
[VScript]: -- @param string_1 string
[VScript]: -- @param string_2 string
[VScript]: -- @param string_3 string
[VScript]: -- @param bool_4 bool
[VScript]: function CDOTATutorial:AddBot( string_1, string_2, string_3, bool_4 ) end
[VScript]: 
[VScript]: ---[[ CDOTATutorial:AddQuest  Add a quest to the quest log ]]
[VScript]: -- @return void
[VScript]: -- @param string_1 string
[VScript]: -- @param int_2 int
[VScript]: -- @param string_3 string
[VScript]: -- @param string_4 string
[VScript]: function CDOTATutorial:AddQuest( string_1, int_2, string_3, string_4 ) end
[VScript]: 
[VScript]: ---[[ CDOTATutorial:AddShopWhitelistItem  Add an item to the shop whitelist. ]]
[VScript]: -- @return void
[VScript]: -- @param string_1 string
[VScript]: function CDOTATutorial:AddShopWhitelistItem( string_1 ) end
[VScript]: 
[VScript]: ---[[ CDOTATutorial:CompleteQuest  Complete a quest, ]]
[VScript]: -- @return void
[VScript]: -- @param string_1 string
[VScript]: function CDOTATutorial:CompleteQuest( string_1 ) end
[VScript]: 
[VScript]: ---[[ CDOTATutorial:CreateLocationTask  Add a task to move to a specific location ]]
[VScript]: -- @return void
[VScript]: -- @param Vector_1 Vector
[VScript]: function CDOTATutorial:CreateLocationTask( Vector_1 ) end
[VScript]: 
[VScript]: ---[[ CDOTATutorial:EnableCreepAggroViz  Alert the player when a creep becomes agro to their hero. ]]
[VScript]: -- @return void
[VScript]: -- @param bool_1 bool
[VScript]: function CDOTATutorial:EnableCreepAggroViz( bool_1 ) end
[VScript]: 
[VScript]: ---[[ CDOTATutorial:EnablePlayerOffscreenTip  Enable the tip to alert players how to find their hero. ]]
[VScript]: -- @return void
[VScript]: -- @param bool_1 bool
[VScript]: function CDOTATutorial:EnablePlayerOffscreenTip( bool_1 ) end
[VScript]: 
[VScript]: ---[[ CDOTATutorial:EnableTowerAggroViz  Alert the player when a tower becomes agro to their hero. ]]
[VScript]: -- @return void
[VScript]: -- @param bool_1 bool
[VScript]: function CDOTATutorial:EnableTowerAggroViz( bool_1 ) end
[VScript]: 
[VScript]: ---[[ CDOTATutorial:FinishTutorial  End the tutorial. ]]
[VScript]: -- @return void
[VScript]: function CDOTATutorial:FinishTutorial(  ) end
[VScript]: 
[VScript]: ---[[ CDOTATutorial:ForceGameStart  Force the start of the game. ]]
[VScript]: -- @return void
[VScript]: function CDOTATutorial:ForceGameStart(  ) end
[VScript]: 
[VScript]: ---[[ CDOTATutorial:GetTimeFrozen  Is our time frozen? ]]
[VScript]: -- @return bool
[VScript]: function CDOTATutorial:GetTimeFrozen(  ) end
[VScript]: 
[VScript]: ---[[ CDOTATutorial:IsItemInWhiteList  Is this item currently in the white list. ]]
[VScript]: -- @return bool
[VScript]: -- @param string_1 string
[VScript]: function CDOTATutorial:IsItemInWhiteList( string_1 ) end
[VScript]: 
[VScript]: ---[[ CDOTATutorial:RemoveShopWhitelistItem  Remove an item from the shop whitelist. ]]
[VScript]: -- @return void
[VScript]: -- @param string_1 string
[VScript]: function CDOTATutorial:RemoveShopWhitelistItem( string_1 ) end
[VScript]: 
[VScript]: ---[[ CDOTATutorial:SelectHero  Select a hero for the local player ]]
[VScript]: -- @return void
[VScript]: -- @param string_1 string
[VScript]: function CDOTATutorial:SelectHero( string_1 ) end
[VScript]: 
[VScript]: ---[[ CDOTATutorial:SelectPlayerTeam  Select the team for the local player ]]
[VScript]: -- @return void
[VScript]: -- @param string_1 string
[VScript]: function CDOTATutorial:SelectPlayerTeam( string_1 ) end
[VScript]: 
[VScript]: ---[[ CDOTATutorial:SetItemGuide  Set the current item guide. ]]
[VScript]: -- @return void
[VScript]: -- @param string_1 string
[VScript]: function CDOTATutorial:SetItemGuide( string_1 ) end
[VScript]: 
[VScript]: ---[[ CDOTATutorial:SetOrModifyPlayerGold  Set gold amount for the tutorial player. (int) GoldAmount, (bool) true=Set, false=Modify ]]
[VScript]: -- @return void
[VScript]: -- @param int_1 int
[VScript]: -- @param bool_2 bool
[VScript]: function CDOTATutorial:SetOrModifyPlayerGold( int_1, bool_2 ) end
[VScript]: 
[VScript]: ---[[ CDOTATutorial:SetQuickBuy  Set players quick buy item. ]]
[VScript]: -- @return void
[VScript]: -- @param string_1 string
[VScript]: function CDOTATutorial:SetQuickBuy( string_1 ) end
[VScript]: 
[VScript]: ---[[ CDOTATutorial:SetShopOpen  Set the shop open or closed. ]]
[VScript]: -- @return void
[VScript]: -- @param bool_1 bool
[VScript]: function CDOTATutorial:SetShopOpen( bool_1 ) end
[VScript]: 
[VScript]: ---[[ CDOTATutorial:SetTimeFrozen  Set if we should freeze time or not. ]]
[VScript]: -- @return void
[VScript]: -- @param bool_1 bool
[VScript]: function CDOTATutorial:SetTimeFrozen( bool_1 ) end
[VScript]: 
[VScript]: ---[[ CDOTATutorial:SetTutorialConvar  Set a tutorial convar ]]
[VScript]: -- @return void
[VScript]: -- @param string_1 string
[VScript]: -- @param string_2 string
[VScript]: function CDOTATutorial:SetTutorialConvar( string_1, string_2 ) end
[VScript]: 
[VScript]: ---[[ CDOTATutorial:SetTutorialUI  Set the UI to use a reduced version to focus attention to specific elements. ]]
[VScript]: -- @return void
[VScript]: -- @param int_1 int
[VScript]: function CDOTATutorial:SetTutorialUI( int_1 ) end
[VScript]: 
[VScript]: ---[[ CDOTATutorial:SetWhiteListEnabled  Set if we should whitelist shop items. ]]
[VScript]: -- @return void
[VScript]: -- @param bool_1 bool
[VScript]: function CDOTATutorial:SetWhiteListEnabled( bool_1 ) end
[VScript]: 
[VScript]: ---[[ CDOTATutorial:StartTutorialMode  Initialize Tutorial Mode ]]
[VScript]: -- @return void
[VScript]: function CDOTATutorial:StartTutorialMode(  ) end
[VScript]: 
[VScript]: ---[[ CDOTATutorial:UpgradePlayerAbility  Upgrade a specific ability for the local hero ]]
[VScript]: -- @return void
[VScript]: -- @param string_1 string
[VScript]: function CDOTATutorial:UpgradePlayerAbility( string_1 ) end
[VScript]: 
...
[VScript]: 
[VScript]: ---[[ CDOTA_BaseNPC:SetAbilityByIndex  Set the ability by index. ]]
[VScript]: -- @return void
[VScript]: -- @param hAbility handle
[VScript]: -- @param iIndex int
[VScript]: function CDOTA_BaseNPC:SetAbilityByIndex( hAbility, iIndex ) end
[VScript]: 
...
[VScript]: 
[VScript]: ---[[ CDOTA_BaseNPC:StartGestureWithPlaybackRate  Add the given gesture activity with a playback rate override. ]]
[VScript]: -- @return void
[VScript]: -- @param nActivity int
[VScript]: -- @param flRate float
[VScript]: function CDOTA_BaseNPC:StartGestureWithPlaybackRate( nActivity, flRate ) end
[VScript]: 
...
[VScript]: 
[VScript]: ---[[ CDOTA_ItemSpawner:GetItemName  Returns the item name ]]
[VScript]: -- @return string
[VScript]: function CDOTA_ItemSpawner:GetItemName(  ) end
[VScript]: 
...
[VScript]: 
[VScript]: ---[[ CPropVRHand:AddHandAttachment  Add the attachment to this hand ]]
[VScript]: -- @return void
[VScript]: -- @param hAttachment handle
[VScript]: function CPropVRHand:AddHandAttachment( hAttachment ) end
[VScript]: 
[VScript]: ---[[ CPropVRHand:GetHandAttachment  Get the attachment on this hand ]]
[VScript]: -- @return handle
[VScript]: function CPropVRHand:GetHandAttachment(  ) end
[VScript]: 
[VScript]: ---[[ CPropVRHand:SetHandAttachment  Set the attachment for this hand ]]
[VScript]: -- @return void
[VScript]: -- @param hAttachment handle
[VScript]: function CPropVRHand:SetHandAttachment( hAttachment ) end
[VScript]: 
...
[VScript]: 
[VScript]: ---[[ GlobalSys:CommandLineCheck  CommandLineCheck(name) : returns true if the command line param was used, otherwise false. ]]
[VScript]: -- @return table
[VScript]: -- @param string_1 string
[VScript]: function GlobalSys:CommandLineCheck( string_1 ) end
[VScript]: 
[VScript]: ---[[ GlobalSys:CommandLineFloat  CommandLineFloat(name) : returns the command line param as a float. ]]
[VScript]: -- @return table
[VScript]: -- @param string_1 string
[VScript]: -- @param float_2 float
[VScript]: function GlobalSys:CommandLineFloat( string_1, float_2 ) end
[VScript]: 
[VScript]: ---[[ GlobalSys:CommandLineInt  CommandLineInt(name) : returns the command line param as an int. ]]
[VScript]: -- @return table
[VScript]: -- @param string_1 string
[VScript]: -- @param int_2 int
[VScript]: function GlobalSys:CommandLineInt( string_1, int_2 ) end
[VScript]: 
[VScript]: ---[[ GlobalSys:CommandLineStr  CommandLineStr(name) : returns the command line param as a string. ]]
[VScript]: -- @return table
[VScript]: -- @param string_1 string
[VScript]: -- @param string_2 string
[VScript]: function GlobalSys:CommandLineStr( string_1, string_2 ) end
[VScript]: 
