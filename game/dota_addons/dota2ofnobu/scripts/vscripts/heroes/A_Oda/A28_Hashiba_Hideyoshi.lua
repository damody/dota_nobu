...
function A28R_old_start( keys )
	...
	for i=1,boom_num do
		Timers:CreateTimer(boom_delay*(i-1), function()
			...
			for _,enemy in pairs(enemies) do
				enemy:AddNewModifier(caster,nil,"modifer_stun",{duration=boom_stun_duration})
				ApplyDamage({
					attacker=caster,
					victim=enemy,
...
function A28T_old( keys )
	...
	Kagutsuchi:SetBaseDamageMax(250+level*100)
	Kagutsuchi:SetBaseDamageMin(200+level*110)
