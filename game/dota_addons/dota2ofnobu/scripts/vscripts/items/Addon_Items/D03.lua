function item_D03( keys )
	...
	-- local particle2 = ParticleManager:CreateParticle("particles/item_d01_3/d01_3.vpcf",PATTACH_POINT,caster)
	...
	-- local particle = ParticleManager:CreateParticle("particles/item_d01_3/d01_3_c.vpcf",PATTACH_POINT,caster)
	-- ParticleManager:SetParticleControl(particle,0, point+Vector(0,0,0))
	-- local num = 0
	-- local tem_p1 = point+Vector(0,0,height)
	-- local tem_p2 = nil
	-- local function ltt( ... )
	-- 	if num == 10 then
	...
	-- 		tem_p2 = tem_p1
 -- 			ParticleManager:DestroyParticle(particle,false)
	-- 		particle = ParticleManager:CreateParticle("particles/item_d01_3/d01_3_c.vpcf",PATTACH_POINT,caster)
